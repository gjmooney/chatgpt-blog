    ...
    <article className="text-wh-500 leading-8">
      ...
      {isEditable && (
        <div className="border-2 rounded-md bg-wh-50 p-3 mb-3">
          ...
          <p className="my-1 p0 text-xs">What type of writer do you want?</p>
      ...
      <div
        className={
          isEditable ? "border-2 rounded-md bg-wh-50 p3" : "w-full max-w-full"
        }
      >
        {isEditable && (
          <>
            <EditorMenuBar editor={editor} />
            <hr className="border-1 mt2 mb-5" />
          </>
        )}
